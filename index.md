...
venue: "Emory University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "100 Woodruff Cir Suite 231, Rooms 110 and 120, Atlanta, GA 30322"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Elyse Morin", "David Nicholson", "Joongsup (Jay) Lee", "Sena Agezo" ] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Stephanie Prince", "Kate Roman", "Eric Maltbie", "David Hercules", "Dmitri Zaras", "Sara Fielder", "Robert Thorstadt", "Marko Bajic", "Kun Tian", "Matt Malishev", "Jim Kwon", "Jessica Owensby"]    
email: ["dnicho4@emory.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
